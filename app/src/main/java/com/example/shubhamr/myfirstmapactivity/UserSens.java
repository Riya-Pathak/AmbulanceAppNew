...
public class UserSens extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   hospitallat = 28.472785;
      //  hospitallong = 77.182095;
   ...
   /*     picked.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String uri = "http://maps.google.com/maps?f=d&hl=en&saddr=" + locationofuserlat + "," + locationofuserlong + "&daddr=" + hospitallat + "," + hospitallong;
